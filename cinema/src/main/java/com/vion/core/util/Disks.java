...
public class Disks {
   ...
   public static String getRelativePath(String base, String path) {
       ...
       StringBuilder sb = new StringBuilder(Strings.copyMulti("../", bb.length - pos - dir));
       return sb.append(Collections.concat(pos, ff.length - pos, "/", ff)).toString();
   }
   ...
   public static String getCanonicalPath(String path) {
       ...
       if (path.charAt(0) == '/')
           return new StringBuffer(Collections.concat("/", paths)).insert(0, '/').toString();
       return Collections.concat("/", paths);
   }
   ...
   public static String absolute(String path) {
       return absolute(path, Classes.getClassLoader(), Encoding.defaultSysEncoding());
   }
   ...
   public static String normalize(String path) {
       return normalize(path, Encoding.defaultSysEncoding());
   }
