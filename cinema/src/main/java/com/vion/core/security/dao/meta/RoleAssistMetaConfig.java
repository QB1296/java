 ...
 */
public class RoleAssistMetaConfig implements EntityMetaConfig{

	/* (non-Javadoc)
	 * @see com.vion.core.basic.EntityMetaConfig#getEntiyClass()*/
	@Override
	public Class<?> getEntiyClass() {
		return VtpRoleAssist.class;
	}
	...
	public static RoleAssistMetaConfig me(){
		return new RoleAssistMetaConfig();
	}
