 ...
 */
@ObjectCreate(pattern="premission-mapping/moudle/rowRule/sql")
public class RowRuleSQL extends SQL{
	
	@BeanPropertySetter(pattern="premission-mapping/moudle/rowRule/sql")
