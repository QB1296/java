...
package com.vion.core.hibernate.userType;
...
public class EnumUserType implements UserType, ParameterizedType {
	...
	private static final String DEFAULT_IDENTIFIER_METHOD_NAME = "getName";
	private static final String DEFAULT_VALUE_OF_METHOD_NAME = "keyOf";
	 ...
	 * @param clazz
	 */
	public EnumUserType(Class<?> clazz) {
		enumClass = clazz;
	}
	...
	public void setParameterValues(Properties parameters) {
		...
		String enumClassName = parameters
				.getProperty(PROPERTY_NAME_ENUM_CLASS_NAME);
		...
		String identifierMethodName = parameters
				.getProperty(PROPERTY_NAME_IDENTIFIER_METHOD,
		...
		try {
			...
			throw new HibernateException(
					"Failed to obtain identifier method named '"
							+ identifierMethodName + "' in class '"
							+ enumClass.getName() + "' given by property '"
							+ PROPERTY_NAME_IDENTIFIER_METHOD + "'", e);
		}
		...
		try {
			...
			throw new HibernateException("Failed to obtain a method named '"
					+ valueOfMethodName
					+ "', which accepts an argument of type '" + identifierType
					+ "' in class '" + enumClass.getName() + "' for property '"
					+ PROPERTY_NAME_VALUE_OF_METHOD + "'", e);
		}
	}
