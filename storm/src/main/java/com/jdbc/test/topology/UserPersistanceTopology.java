...
import com.jdbc.bolt.JdbcInsertBolt;
import com.jdbc.bolt.JdbcLookupBolt;
...
public class UserPersistanceTopology extends AbstractUserTopology {
    ...
    public StormTopology getTopology() {
        ...
        List<Column> schemaColumns = Lists.newArrayList(new Column("create_date", Types.TIMESTAMP),
