...
public class MysqlStateTopology {
	...
	public static void main(final String[] args) {
		final String dburl = "jdbc:mysql://192.168.9.7:3306/storm_test?user=root&password=root&createDatabaseIfNotExist=true&autoReconnect=true&characterEncoding=utf8";
